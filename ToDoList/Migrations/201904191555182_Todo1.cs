namespace ToDoList.Migrations
{
    ...
    public partial class Todo1 : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.UserAttachments", "UserTask_Id", "dbo.UserTasks");
            DropForeignKey("dbo.UserTasks", "User_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.UserAttachments", "User_Id", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.UserAttachments", new[] { "UserTask_Id" });
            DropIndex("dbo.UserAttachments", new[] { "User_Id" });
